...
queues:2=@2q \
queues:3=@3q -- \
--id=@1q create queue other-config:min-rate=100 other-config:max-rate=3000000 -- \
--id=@2q create queue other-config:min-rate=100 other-config:max-rate=3000000 -- \
--id=@3q create queue other-config:min-rate=100 other-config:max-rate=4000000
