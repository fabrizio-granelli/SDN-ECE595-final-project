...
while True:
    ...
    print("----------------------------")
    time.sleep(60)
    os.system("""curl -X DELETE -d '{"address":"10.0.3.1/24"}' http://localhost:8080/router/0000000000000001""")
    os.system("""curl -X DELETE -d '{"address":"10.0.6.1/24"}' http://localhost:8080/router/0000000000000002""")
